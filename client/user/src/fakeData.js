...
export const customerProfile = {
  fullname: "Khoa Thống Võ",
  email: "khoa@gmail.com",
  address: "Long Thạnh Mỹ, Quận 9, HCM",
  gender: "Nam",
  phone: "6663629",
  dateOfBirth: "05/05/2000",
};

export const customerMedicalHistory = [
  {
    date: "15/02/2023",
    desease: "Ho, Đau họng",
    doctor: "Mr.A",
...
export const blogsSaved = [
  {
    category: "Công nghệ",
    title: "Đo huyết áp nhanh",
    content:
      "Người được đo huyết áp ngồi trên ghế tựa, cánh tay duỗi thẳng trên bàn, nếp khuỷu tay nằm ngang mức tim. Ngoài ra, bệnh nhân cũng có thể được đo huyết áp ở các tư thế nằm, đứng. Người cao tuổi hoặc có bệnh đái tháo đường nên đo huyết áp ở tư thế đứng nhằm xác định có tình trạng hạ huyết áp tư thế không.",
    author: "Doctor.G",
