    ...
    <div className='bg-light container w-100 h-100 d-flex flex-column gap-3'>
      <div className='row '>
        ...
        <div className="col-12 d-flex align-items-center py-3 justify-content-between">
          ...
          {
            createBlog ? <button className="btn btn-primary" style={{ width: "10%" }} type="submit"> Save </button> : <button className="btn btn-primary" onClick={onChangeView} style={{ width: "10%" }} type="submit"> <BsPlus className='fs-5' />Add New</button>
          }
        </div>
